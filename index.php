...
<div class="row">
 ...
 <div class="small-3 columns">
     <a href="allcontributions.php" class="uppercase">Se alla bidrag</a>
 </div>
</div>
...
?>
      ...
      <?php
        ...
        echo "<a href='' target='_blank'><img src='" . $photo->images->low_resolution->url . "'></a><br />";
       ?> 
         <div class="row">
          <div class="small-4 medium-4 small-4 columns">     
              <p><i class="fi-heart <?php if($photo->likes->count>0){echo 'red';} ?>"> </i><?php echo $photo->likes->count;?> </p> 
          </div>
